    ...
    <motion.div variants={containerAnimation} initial="initial" whileInView="whileInView" viewport="viewport" id="scrollspyProjects" className="projects container my-8 pt-5">
      ...
      <motion.div variants={containerAnimation} viewport="viewport">
        ...
        <Project
          ...
          img={{ src: '/Kayamanan.png', alt: 'Kayamanan: The Hunt for Philippine Treasures main menu interface' }}
          gif={{ src: '/Quest 1.gif', alt: 'Kayamanan: The Hunt for Philippine Treasures sample output' }}
          technologies={[
            {
          ...
          links={{
            sourceCode: 'https://github.com/adriandotdev/Kayamanan-A-Hunt-for-Philippine-Treasures-THESIS-',
        ...
        <Project
          ...
          img={{
            src: '/Yanyan_Store.png', alt: "Yan-Yan's Store user interface"
          }}
          gif={{ src: '/Products Overview.gif', alt: "Yan-Yan's Store sample output" }}
          technologies={[
            {
          ...
          links={{
            sourceCode: 'https://github.com/adriandotdev/yanyan-store/tree/master'
          }}
          isReversed={true}
        />
        ...
        <Project
          ...
          img={{ src: '/Food Hub.png', alt: 'Food Hub Ordering System sample user interface' }}
          gif={{ src: '/Cart.gif', alt: 'Food Hub Ordering System sample output' }}
          technologies={[
            {
              src: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg",
              alt: "react.js logo"
          ...
          links={{
            sourceCode: 'https://github.com/adriandotdev/Food-Hub-Software-Engineering-'
          }}
        />
        ...
        <Project
          ...
          img={{ src: '/Flashcard.png', alt: 'Flashcard sample user interface' }}
        ...
        <Project
          ...
          img={{ src: '/Recipe_Search_App.png', alt: 'Recipe Search App sample user interface' }}
        ...
        <Project
          ...
          img={{ src: '/YGO.png', alt: 'YGO Programming Center sample user interface' }}
          gif={{ src: '/Enrolling Courses.gif', alt: 'YGO Programming Center sample output' }}
          technologies={[
            {
          ...
          links={{
            sourceCode: 'https://github.com/adriandotdev/academic-courseworks/tree/ygo-programming-center-gui',
          }}
          isReversed={true}
        />
      </motion.div>
