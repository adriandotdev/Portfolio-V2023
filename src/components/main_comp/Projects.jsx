              ...
              <Col className="col-12 col-lg-6">
                ...
                <div>
                  <motion.div variants={ctaContainer} viewport="viewport" className="d-lg-flex justify-content-lg-end gap-2">
                    ...
                    <motion.a variants={fromBottomAnimation} viewport="viewport" target="blank" className={`btn ${isNightMode ? "btn-outline-contrastColor" : "btn-outline-bodyTextColor"}`} href="https://drive.google.com/file/d/1Vsev3wCtPzW2sHAJHvgDeURUYnKYFxv6/view?usp=sharing" role="button"
                    >APK File</motion.a
                    >
                  </motion.div>
                </div>
