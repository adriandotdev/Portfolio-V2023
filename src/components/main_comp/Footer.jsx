function Footer() {
	return (
		<footer className="container-fluid bg-dark pt-5 pb-3 d-flex flex-column justify-content-center align-items-center gap-3">
			<div className="container">
				<img
					className="portfolio-logo mx-auto w-100"
					src="/images/Logo.png"
				...
				<div className="d-flex justify-content-center gap-3">
					...
					<div style={{ height: "50px" }} className="project-icon footer-icon">
						<a
							target="blank"
							href="https://github.com/adriandotdev?tab=overview&from=2023-01-01&to=2023-01-14"
							className="text-decoration-none h-100"
			...
			<div>
				<p className="text-white text-center fw-bold fs-4 p-0 m-0">
					Adrian.dev
				</p>
				<p className="text-white text-center fw-bolder">
