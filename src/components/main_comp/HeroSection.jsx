...
function HeroSection() {
	...
	return (
		<div className="hero-section">
			<div
				id="scrollspyHeroSection"
				className={`hero-page container ${
					isNightMode && "hero-page--body__darkmode"
				}`}
			>
				<div className="hero-content row justify-content-center">
					...
					>
						<motion.h1
							...
							viewport="viewport"
							id="hero--heading"
							className={`display-1 text-center text-xl-center ${
						...
						<motion.p
							...
							viewport="viewport"
							id="hero-page__subheading"
							className={`mx-auto h2 text-center text-xl-center font-montserrat ${
								isNightMode ? "text-contrastColor" : "text-darkSecondary"
							}`}
						>
							...
							<span
								className={`${
									isNightMode
										? "hero-subheading--span__nightmode"
					...
					<div className="col align-self-center d-none  col-md-5 col-lg-4">
						<div className="container text-center">
							<motion.div
								...
								className={`${
									isNightMode
										? "image-background__darkmode"
										: "image-background__daymode"
								}`}
							>
								<img
