        ...
        <motion.div variants={titleSection} className="row align-items-start">
          ...
          <motion.div variants={titleSection} className="col-12 col-xl-6">
            ...
            <motion.p variants={titleAnimation} id='about--paragraph' className={`text-center text-xl-start ${isNightMode ? "text-contrastColor" : "text-bodyTextColor"}`}>
              I am pursuing a Bachelor of Science in Computer Science and am currently in my senior year at Pamantasan ng Cabuyao (University of Cabuyao). I am a passionate, motivated, and solution-oriented web developer who loves to create personal projects, connect with like-minded individuals, and constantly learn new skills. I started learning to program in my first year of college in 2019 and actively initiated to develop some of our school projects to become comfortable with it. Creating those projects made me realize that I enjoy creating user interfaces and decided to start learning web development. With that, I am open to every opportunity that comes along the way.
            </motion.p>
