  ...
  return (
    <motion.div variants={titleSection} initial="initial" whileInView="whileInView" viewport="viewport" id="scrollspyAboutMe" className="about container mt-5 pt-5">
      ...
      <motion.div className="container" viewport="viewport">
        <motion.div variants={titleSection} viewport="viewport" className="row align-items-start">
          <motion.div variants={image} viewport="viewport" className="col-12 col-xl-6 text-center align-self-start">
            <img
          ...
          <motion.div variants={titleSection} viewport="viewport" className="col-12 col-xl-6">
            <motion.h1 variants={titleAnimation} viewport="viewport" className={`text-center text-xl-start mt-3 mt-xl-0 font-montserrat-medium ${isNightMode ? "text-darkModeAccentColor" : "text-dark"}`}>
              Hello! I'm Adrian Nads
            </motion.h1>

            <motion.p variants={titleAnimation} viewport="viewport" id='about--paragraph' className={`text-center text-xl-start ${isNightMode ? "text-contrastColor" : "text-bodyTextColor"}`}>
            ...
            <motion.div className='d-xl-none' variants={titleAnimation} viewport="viewport">
              <ListGroup>
                ...
                <ListGroup.Item className={`${isNightMode && 'bg-dark border'}`}>
                  ...
                  <p className="fs-6 fst-italic text-muted text-center text-xl-start">
            ...
            <motion.div className="d-none d-xl-block" variants={titleAnimation} viewport="viewport">
              <h2 className={`${isNightMode ? 'text-darkModeAccentColor' : 'text-bodyTextColor'}`}>Relevant Experiences and Activities</h2>
              <ul>
                <li>
                  <div className={`h5 mt-3 ${isNightMode && 'text-contrastColor'}`}>
                    Prototype and Software Exposition
                  </div>
                  <span className={`${isNightMode && 'text-darkModeAccentColor'}`}>associated by Pamantasan ng Cabuyao</span>
                </li>
                <li>
                  <div className={`h5 mt-3 ${isNightMode && 'text-contrastColor'}`}>
                    Front End Developer Intern
                  </div>
                  <span className={`${isNightMode && 'text-darkModeAccentColor'}`}>at Pixel8 Web Solutions & Consultancy Inc. (February - April 2023)</span>
                </li>
                <li>
                  <div className={`h5 mt-3 ${isNightMode && 'text-contrastColor'}`}>
                    Programming Training and Competition (Finalist)
                  </div>
                  <span className={`${isNightMode && 'text-darkModeAccentColor'}`}>by Association of Computer Science Students (ACSS) </span>
                </li>
              </ul>
            </motion.div>
          </motion.div>
